...
public class Screen11Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for(Answer s:sList)
       {
             ...
             Radio16.setText(sList.get(3).getD());
                 ...
                 q1=Text1.getText();
                 a1=sList.get(0).getCorrectAns();
                 q2=Text3.getText();
                 a2=sList.get(1).getCorrectAns();
                 q3=Text2.getText();
                 a3=sList.get(2).getCorrectAns();
                 q4=Text4.getText();
                 a4=sList.get(3).getCorrectAns();
 ...
 if(Radio1.isSelected()){
        if(Radio1.getText().equalsIgnoreCase(a1)){
            score=score+10;
 ...
 if(Radio2.isSelected()){
        if(Radio2.getText().equalsIgnoreCase(a1)){
            score=score+10;
 ...
 if(Radio3.isSelected()){
        if(Radio3.getText().equalsIgnoreCase(a1)){
            score=score+10;
  ...
  if(Radio4.isSelected()) {
        if(Radio4.getText().equalsIgnoreCase(a1)){
            score=score+10;
...
if(Radio5.isSelected()){
        if(Radio5.getText().equalsIgnoreCase(a2)){
            score=score+10;
 ...
 if(Radio6.isSelected()){
        if(Radio6.getText().equalsIgnoreCase(a2)){
            score=score+10;
...
if(Radio7.isSelected()){
        if(Radio7.getText().equalsIgnoreCase(a2)){
            score=score+10;
...
if(Radio8.isSelected()){
        if(Radio8.getText().equalsIgnoreCase(a2)){
            score=score+10;
...
//Question3
 if(Radio9.isSelected()){
        if(Radio9.getText().equalsIgnoreCase(a3)){
            score=score+10;
 ...
 if(Radio0.isSelected()){
        if(Radio0.getText().equalsIgnoreCase(a3)){
            score=score+10;
...
if(Radio11.isSelected()){
        if(Radio11.getText().equalsIgnoreCase(a3)){
            score=score+10;
...
if(Radio12.isSelected()){
        if(Radio12.getText().equalsIgnoreCase(a3)){
            score=score+10;
...
if(Radio13.isSelected()){
        if(Radio13.getText().equalsIgnoreCase(a4)){
            score=score+10;
 ...
 if(Radio14.isSelected()){
        if(Radio14.getText().equalsIgnoreCase(a4)){
            score=score+10;
 ...
 if(Radio15.isSelected()){
        if(Radio15.getText().equalsIgnoreCase(a4)){
            score=score+10;
...
if(Radio16.isSelected()){
    if(Radio16.getText().equalsIgnoreCase(a4)){
            score=score+10;
    ...
    private void next(ActionEvent event) throws IOException {
     ...
     javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("Screen12.fxml"));
            Parent root = loader.load();
    Screen12Controller controller=loader.getController();
    controller.write(q1, a1, q2, a2, q3, a3, q4, a4);
